...
% chanIn=setdiff(chanIn,chanIn(iiOutPlus2));
% [m s]=normfit(ieegSTD(chanIn));
% iiOutPlus3=find(ieegSTD(chanIn)>(3*s+m));
% chanIn=setdiff(chanIn,chanIn(iiOutPlus3));
% [m s]=normfit(ieegSTD(chanIn));
% iiOutPlus4=find(ieegSTD(chanIn)>(3*s+m));
% chanIn=setdiff(chanIn,chanIn(iiOutPlus4));
