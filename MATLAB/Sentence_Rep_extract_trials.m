...
Task.Conds(1).Field(1).Time=[0 4000];
Task.Conds(1).Field(1).Name='Whole';
...
Task.Conds(2).Name='JLwords';
Task.Conds(2).Field = [];
Task.Conds(2).Field(1).Epoch='Start';
Task.Conds(2).Field(1).Time=[0 4000];
Task.Conds(2).Field(1).Name='Whole';
...
Task.Conds(3).Field(1).Time=[0 4000];
Task.Conds(3).Field(1).Name='Whole';
...
%                 Task.Conds(iC).Name '_' Task.Conds(iC).Field(iF).Name '_' Task.Base.Name '.mat'],'chanSig','ieegCARHG','ieegBaseCARHG','ieegCARHGZ','ieegBaseCARHGZ');
              save([DUKEDIR '\Stats\timePerm\' Subject(SN).Name '_' Task.Name '_' ...
                Task.Conds(iC).Name '_' Task.Conds(iC).Field(iF).Name '_' Task.Base.Name '.mat'],'chanSig','signal');
              clear chanSig ieegCARHG ieegBaseCARHG ieegCARHGZ ieegBaseCARHGZ 'signal'
        end
    end
end
