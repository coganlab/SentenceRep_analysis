...
Task.Conds(1).Field(2).Name='StartWhole';
Task.Conds(1).Field(2).Epoch='Start';
Task.Conds(1).Field(2).Time=[0 4000];
...
% Task.Conds(1).Field(1).Epoch='Auditory';
% Task.Conds(1).Field(1).Time=[-500 1000];
% Task.Conds(1).Field(2).Name='GoPart';
% Task.Conds(1).Field(2).Epoch='Go';
% Task.Conds(1).Field(2).Time=[-500 2000];
% Task.Conds(1).Field(3).Name='ResponsePart';
% Task.Conds(1).Field(3).Epoch='ResponseStart';
% Task.Conds(1).Field(3).Time=[-1000 1500];
...
Task.Conds(3).Field(2).Name='StartWhole';
Task.Conds(3).Field(2).Epoch='Start';
Task.Conds(3).Field(2).Time=[0 4000];
...
Task.Conds(5).Field(2).Name='StartWhole';
Task.Conds(5).Field(2).Epoch='Start';
Task.Conds(5).Field(2).Time=[0 4000];
